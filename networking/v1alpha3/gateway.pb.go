...
type Server_TLSOptions struct {
	...
	// Optional: The path to a file containing certificate revocation list
	// to use in verifying a presented client side certificate.
	Crl string `protobuf:"bytes,11,opt,name=crl,proto3" json:"crl,omitempty"`
...
func (m *Server_TLSOptions) GetCrl() string {
	if m != nil {
		return m.Crl
	}
	return ""
...
var fileDescriptor_067d98d02f84cc0b = []byte{
	...
	,
}
...
func (m *Server_TLSOptions) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Crl) > 0 {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintGateway(dAtA, i, uint64(len(m.Crl)))
		i += copy(dAtA[i:], m.Crl)
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
